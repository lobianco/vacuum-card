function t(t, e, a, o) {
  var n,
    i = arguments.length,
    r =
      i < 3 ? e : null === o ? (o = Object.getOwnPropertyDescriptor(e, a)) : o;
  if ('object' == typeof Reflect && 'function' == typeof Reflect.decorate)
    r = Reflect.decorate(t, e, a, o);
  else
    for (var s = t.length - 1; s >= 0; s--)
      (n = t[s]) && (r = (i < 3 ? n(r) : i > 3 ? n(e, a, r) : n(e, a)) || r);
    ...
    : (t) =>
        t instanceof CSSStyleSheet
          ? ((t) => {
              ...
              return ((t) =>
                new i('string' == typeof t ? t : t + '', void 0, o))(e);
            })(t)
          : t,
  {
    is: l,
...
let k = class extends HTMLElement {
  ...
  static createProperty(t, e = y) {
    if (
      ...
      const a = Symbol(),
        o = this.getPropertyDescriptor(t, a, e);
      void 0 !== o && c(this.prototype, t, o);
    }
  }
  static getPropertyDescriptor(t, e, a) {
    const { get: o, set: n } = u(this.prototype, t) ?? {
      get() {
        return this[e];
      },
      set(t) {
    ...
    return {
      ...
      set(e) {
        const i = o?.call(this);
        (n?.call(this, e), this.requestUpdate(t, i, a));
      },
      configurable: !0,
      enumerable: !0,
    };
  ...
  static finalize() {
    ...
    if (null !== t) {
      ...
      if (void 0 !== e)
        for (const [t, a] of e) this.elementProperties.set(t, a);
    }
    this._$Eh = new Map();
    for (const [t, e] of this.elementProperties) {
      const a = this._$Eu(t, e);
      void 0 !== a && this._$Eh.set(a, t);
    }
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const t of a) e.unshift(s(t));
  ...
  _$E_() {
    ...
    for (const a of e.keys())
      this.hasOwnProperty(a) && (t.set(a, this[a]), delete this[a]);
        ...
        n =
          'function' == typeof t.converter
            ...
            : void 0 !== t.converter?.fromAttribute
              ...
              : b;
      this._$Em = o;
      const i = n.fromAttribute(e, t.type);
      ((this[o] = i ?? this._$Ej?.get(o) ?? i), (this._$Em = null));
    }
  }
  requestUpdate(t, e, a, o = !1, n) {
    if (void 0 !== t) {
      const i = this.constructor;
      if (
        (!1 === o && (n = this[t]),
        (a ??= i.getPropertyOptions(t)),
        !(
          (a.hasChanged ?? w)(n, e) ||
          (a.useDefault &&
            a.reflect &&
            n === this._$Ej?.get(t) &&
            !this.hasAttribute(i._$Eu(t, a)))
        ))
      )
        return;
      this.C(t, e, a);
  ...
  C(t, e, { useDefault: a, reflect: o, wrapped: n }, i) {
    (a &&
      !(this._$Ej ??= new Map()).has(t) &&
      (this._$Ej.set(t, i ?? e ?? this[t]), !0 !== n || void 0 !== i)) ||
      (this._$AL.has(t) ||
        (this.hasUpdated || a || (e = void 0), this._$AL.set(t, e)),
      !0 === o && this._$Em !== t && (this._$Eq ??= new Set()).add(t));
  }
  async _$EP() {
...
((k.elementStyles = []),
  ...
  (k[v('elementProperties')] = new Map()),
  (k[v('finalized')] = new Map()),
  f?.({ ReactiveElement: k }),
  (g.reactiveElementVersions ??= []).push('2.1.2'));
const z = globalThis,
  S = (t) => t,
  A = z.trustedTypes,
  $ = A ? A.createPolicy('lit-html', { createHTML: (t) => t }) : void 0,
  x = '$lit$',
  ...
  q = (
    (t) =>
    (e, ...a) => ({ _$litType$: t, strings: e, values: a })
  )(1),
  Z = Symbol.for('lit-noChange'),
  B = Symbol.for('lit-nothing'),
  K = new WeakMap(),
  F = M.createTreeWalker(M, 129);
function W(t, e) {
  if (!N(t) || !t.hasOwnProperty('raw'))
...
const G = (t, e) => {
  ...
  for (let e = 0; e < a; e++) {
    ...
    let s,
      ...
      c = -1,
      u = 0;
    for (; u < a.length && ((r.lastIndex = u), (l = r.exec(a)), null !== l); )
      ((u = r.lastIndex),
        r === V
          ? '!--' === l[1]
            ? (r = R)
            ...
            ? '>' === l[0]
              ...
              : void 0 === l[1]
                ...
                : ((c = r.lastIndex - l[2].length),
                  (s = l[1]),
                  (r = void 0 === l[3] ? L : '"' === l[3] ? D : U))
            : r === D || r === U
              ? (r = L)
              : r === R || r === I
                ? (r = V)
                : ((r = L), (n = void 0)));
    const _ = r === L && t[e + 1].startsWith('/>') ? ' ' : '';
    i +=
      r === V
        ? a + C
        : c >= 0
          ? (o.push(s), a.slice(0, c) + x + a.slice(c) + j + _)
          : a + j + (-2 === c ? e : _);
  }
  return [
    W(t, i + (t[a] || '<?>') + (2 === e ? '</svg>' : 3 === e ? '</math>' : '')),
    o,
  ];
};
class J {
  constructor({ strings: t, _$litType$: e }, a) {
    ...
    for (; null !== (o = F.nextNode()) && s.length < r; ) {
      if (1 === o.nodeType) {
        if (o.hasAttributes())
          for (const t of o.getAttributeNames())
            if (t.endsWith(x)) {
              const e = c[i++],
                a = o.getAttribute(t).split(j),
                r = /([.?@])?(.*)/.exec(e);
              (s.push({
                type: 1,
                index: n,
              ...
              t.startsWith(j) &&
                (s.push({ type: 6, index: n }), o.removeAttribute(t));
        if (H.test(o.tagName)) {
          const t = o.textContent.split(j),
            e = t.length - 1;
          if (e > 0) {
        ...
        if (o.data === E) s.push({ type: 2, index: n });
        else {
          let t = -1;
          for (; -1 !== (t = o.data.indexOf(j, t + 1)); )
            (s.push({ type: 7, index: n }), (t += j.length - 1));
        }
      n++;
    }
  }
...
function Y(t, e, a = t, o) {
  if (e === Z) return e;
  let n = void 0 !== o ? a._$Co?.[o] : a._$Cl;
  const i = P(e) ? void 0 : e._$litDirective$;
  return (
    n?.constructor !== i &&
      (n?._$AO?.(!1),
      void 0 === i ? (n = void 0) : ((n = new i(t)), n._$AT(t, a, o)),
      void 0 !== o ? ((a._$Co ??= [])[o] = n) : (a._$Cl = n)),
    void 0 !== n && (e = Y(t, n._$AS(t, e.values), n, o)),
    e
  );
}
class X {
  ...
  p(t) {
    ...
    for (const a of this._$AV)
      (void 0 !== a &&
        (void 0 !== a.strings
          ? (a._$AI(t, a, e), (e += a.strings.length - 2))
          : a._$AI(t[e])),
        e++);
  }
}
class Q {
  ...
  _(t) {
    (this._$AH !== B && P(this._$AH)
      ? (this._$AA.nextSibling.data = t)
      : this.T(M.createTextNode(t)),
      (this._$AH = t));
  }
  $(t) {
    const { values: e, _$litType$: a } = t,
      o =
        'number' == typeof a
          ? this._$AC(t)
          : (void 0 === a.el &&
              (a.el = J.createElement(W(a.h, a.h[0]), this.options)),
            a);
    if (this._$AH?._$AD === o) this._$AH.p(e);
    else {
      const t = new X(o, this),
        a = t.u(this.options);
      (t.p(e), this.T(a), (this._$AH = t));
    }
  }
  _$AC(t) {
  ...
  k(t) {
    ...
    for (const n of t)
      (o === e.length
        ? e.push((a = new Q(this.O(O()), this.O(O()), this, this.options)))
        : (a = e[o]),
        a._$AI(n),
        o++);
...
class ot extends tt {
  constructor(t, e, a, o, n) {
    (super(t, e, a, o, n), (this.type = 5));
  }
  _$AI(t, e = this) {
    if ((t = Y(this, t, e, 0) ?? B) === Z) return;
    const a = this._$AH,
      o =
        (t === B && a !== B) ||
        t.capture !== a.capture ||
...
(it?.(J, Q), (z.litHtmlVersions ??= []).push('3.3.2'));
const rt = globalThis;
class st extends k {
  constructor() {
    (super(...arguments),
  ...
  update(t) {
    ...
    (this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
      super.update(t),
      (this._$Do = ((t, e, a) => {
        const o = a?.renderBefore ?? e;
        let n = o._$litPart$;
        if (void 0 === n) {
          const t = a?.renderBefore ?? null;
          o._$litPart$ = n = new Q(e.insertBefore(O(), t), t, void 0, a ?? {});
        }
        return (n._$AI(t), n);
...
((st._$litElement$ = !0),
  (st.finalized = !0),
  rt.litElementHydrateSupport?.({ LitElement: st }));
const lt = rt.litElementPolyfillSupport;
(lt?.({ LitElement: st }), (rt.litElementVersions ??= []).push('4.2.2'));
const ct = (t) => (e, a) => {
    void 0 !== a
      ? a.addInitializer(() => {
  ...
  _t = (t = ut, e, a) => {
    const { kind: o, metadata: n } = a;
    let i = globalThis.litPropertyMetadata.get(n);
    if (
      (void 0 === i && globalThis.litPropertyMetadata.set(n, (i = new Map())),
      ...
      return {
        set(a) {
          ...
          (e.set.call(this, a), this.requestUpdate(o, n, t, !0, a));
        },
        init(e) {
    ...
    if ('setter' === o) {
      ...
      return function (a) {
        const n = this[o];
        (e.call(this, a), this.requestUpdate(o, n, t, !0, a));
      };
    }
  ...
  return (e, a) =>
    'object' == typeof a
      ...
      : ((t, e, a) => {
          ...
          return (
            e.constructor.createProperty(a, t),
            o ? Object.getOwnPropertyDescriptor(e, a) : void 0
          );
        })(t, e, a);
}
function mt(t) {
...
var pt = function (t, e, a, o) {
  ...
  return ((n.detail = a), t.dispatchEvent(n), n);
};
var ft,
  vt,
  bt,
...
function pa() {
  ...
  var t = (function () {
      if (wt) return bt;
      wt = 1;
      var t = 'object' == typeof ma && ma && ma.Object === Object && ma;
      return (bt = t);
    })(),
    e = 'object' == typeof self && self && self.Object === Object && self,
    a = t || e || Function('return this')();
  return (yt = a);
}
function fa() {
  if (St) return zt;
...
function ba() {
  ...
  return (Pt = function (a) {
    return 'symbol' == typeof a || (e(a) && '[object Symbol]' == t(a));
  });
}
function wa() {
  if (It) return Rt;
...
function ya() {
  ...
  var t,
    e = (function () {
      if (Ht) return Dt;
      Ht = 1;
      var t = pa()['__core-js_shared__'];
      return (Dt = t);
    })(),
    a = (t = /[^.]+$/.exec((e && e.keys && e.keys.IE_PROTO) || ''))
      ? 'Symbol(src)_1.' + t
      : '';
...
function ka() {
  ...
  return (Ft = function (i) {
    return !(!a(i) || e(i)) && (t(i) ? c : n).test(o(i));
  });
}
function za() {
  if (Xt) return Yt;
  ...
  var t = (function () {
    ...
    o = (function () {
      ...
      return (se = function (a) {
        var o = this.__data__;
        return t ? void 0 !== o[a] : e.call(o, a);
      });
    })(),
    n = (function () {
      if (ue) return ce;
      ...
      return (ce = function (e, a) {
        ...
        return (
          ...
          (o[e] = t && void 0 === a ? '__lodash_hash_undefined__' : a),
          this
        );
      });
    })();
...
function $a() {
  ...
  return (fe = function (e, a) {
    for (var o = e.length; o--; ) if (t(e[o][0], a)) return o;
    return -1;
  });
}
function xa() {
  ...
  var t = ge
    ...
    e = (function () {
      ...
      return (be = function (a) {
        ...
        return !(
          n < 0 ||
          (n == o.length - 1 ? o.pop() : e.call(o, n, 1), --this.size, 0)
        );
      });
    })(),
    a = (function () {
    ...
    n = (function () {
      ...
      return (Ae = function (e, a) {
        var o = this.__data__,
          n = t(o, e);
        return (n < 0 ? (++this.size, o.push([e, a])) : (o[n][1] = a), this);
      });
    })();
  function i(t) {
    var e = -1,
...
function Ea() {
  ...
  return (Te = function (e, a) {
    var o = e.__data__;
    return t(a) ? o['string' == typeof a ? 'string' : 'hash'] : o.map;
  });
}
function Ca() {
  if (Ke) return Be;
  ...
  var t = ja(),
    ...
    n = (function () {
      ...
      return (qe = function (e, a) {
        var o = t(this, e),
          n = o.size;
        return (o.set(e, a), (this.size += o.size == n ? 0 : 1), this);
      });
    })();
  function i(t) {
    var e = -1,
  ...
  var t = (function () {
    ...
    function e(a, o) {
      ...
      var n = function () {
        ...
        var r = a.apply(this, t);
        return ((n.cache = i.set(e, r) || i), r);
      };
      return ((n.cache = new (e.Cache || t)()), n);
    }
    return ((e.Cache = t), (Fe = e));
  })();
  return (Ge = function (e) {
    var a = t(e, function (t) {
  ...
  var t = fa(),
    e = ta
      ...
      : ((ta = 1),
        (Qe = function (t, e) {
          for (
            var a = -1, o = null == t ? 0 : t.length, n = Array(o);
            ++a < o;
          )
            n[a] = e(t[a], a, t);
          return n;
    ...
    a = ha(),
    o = ba(),
    n = t ? t.prototype : void 0,
    i = n ? n.toString : void 0;
  return (
    (ea = function t(n) {
      if ('string' == typeof n) return n;
      if (a(n)) return e(n, t) + '';
      if (o(n)) return i ? i.call(n) : '';
      var r = n + '';
...
function Pa() {
      ...
      var t = Ma(),
        ...
        o = t(function (t) {
          ...
          return (
            ...
            t.replace(e, function (t, e, n, i) {
              o.push(n ? i.replace(a, '$1') : e || t);
            }),
            o
          );
        });
  ...
  return (ia = function (n, i) {
    return t(n) ? n : e(n, i) ? [n] : a(o(n));
  });
}
function Na() {
  if (ua) return ca;
  ...
  return (ca = function (a, o) {
    for (var n = 0, i = (o = t(o, a)).length; null != a && n < i; )
      a = a[e(o[n++])];
    return n && n == i ? a : void 0;
  });
}
var Ta = (function () {
    if (da) return _a;
    da = 1;
    var t = Na();
    return (_a = function (e, a, o) {
      var n = null == e ? void 0 : t(e, a);
      return void 0 === n ? o : n;
    });
  })(),
  Va = ga(Ta),
  Ra = {
    cleaning: 'Netejant',
    auto: 'Neteja automàtica',
    spot: 'Neteja puntual',
    edge: 'Neteja de vores',
    single_room: "Neteja d'una sola habitació",
    paused: 'En pausa',
    idle: 'Inactiu',
    stop: 'Aturat',
    charging: 'Carregant',
    returning: 'Tornant a la base',
    returning_home: 'Tornant a la base',
    docked: 'A la base',
    unknown: 'Desconegut',
    offline: 'Fora de línia',
    error: 'Errada',
    charger_disconnected: 'Carregador desconnectat',
    remote_control_active: 'Control remot actiu',
    manual_mode: 'Mode manual',
    shutting_down: "S'està apagant",
    updating: "S'està actualitzant",
    going_to_target: "Anant a l'objectiu",
    zoned_cleaning: 'Neteja per zones',
    segment_cleaning: 'Neteja per segments',
  },
  Ia = {
    gentle: 'Delicat',
    silent: 'Silenciós',
  ...
  La = {
    name: "Targeta d'aspiradora",
    description: "La targeta d'aspiradora permet controlar el robot aspirador.",
    start: 'Neteja',
    continue: 'Continua',
    pause: 'Pausa',
    stop: 'Atura',
  ...
  Da = {
    actions_array:
      "AVÍS: 'actions' està reservat per sobreescriure les accions per defecte dels botons existents. Si la vostra intenció era afegir accions addicionals, utilitzeu l'opció 'shortcuts' en el seu lloc.",
  },
  Ha = {
    ...
    code_only_note:
      "Nota: Configuració de les accions i estadístiques només disponible des de l'Editor de Codi.",
  },
  qa = {
    status: Ra,
    source: Ia,
  ...
  Ba = {
    ...
    remote_control_active: '正在遥控',
    manual_mode: '手动模式',
    shutting_down: '关机',
    updating: '更新中',
    going_to_target: '前往目标',
    zoned_cleaning: '区域清洁',
    segment_cleaning: '分区清洁',
  },
  Ka = {
    gentle: '轻柔',
    silent: '安静',
  ...
  Wa = { invalid_config: '错误的设置', missing_entity: '必须指定一个实体!' },
  Ga = {
    actions_array:
      '警告: "动作" 是为了覆盖现有按钮的默认动作而保留的。如果你的目的是增加额外的动作，请使用"快捷键"选项来代替。',
  },
  Ja = {
    entity: '实体 (必填)',
    map: '地图 (选填)',
  ...
  Qa = {
    ...
    charging: 'Nabíjí se',
    returning: 'Vrací se',
    returning_home: 'Návrat na základnu',
    docked: 'Ve stanici',
    unknown: 'Neznámý',
    offline: 'Vypnuto',
    error: 'Chyba',
    charger_disconnected: 'Nabíječka odpojena',
    remote_control_active: 'Dálkové ovládání aktivní',
    manual_mode: 'Manuální režim',
    shutting_down: 'Vypínání',
    updating: 'Aktualizace',
    going_to_target: 'Směřuje k cíli',
    zoned_cleaning: 'Zónové čištění',
    segment_cleaning: 'Čištění segmentu',
  },
  to = {
    gentle: 'Mírný',
    silent: 'Tichý',
  ...
  oo = {
    actions_array:
      "VAROVÁNÍ: 'actions' jsou rezervovány pro přepsání původních akcí u existujících tlačítek. Pokud jste chtěli měli v plánu přidat další akce, použijte namísto toho možnost 'shortcuts'.",
  },
  no = {
    ...
    code_only_note:
      'Poznámka: Nastavení akcí a infa je dostupné pouze v editoru kódu.',
  },
  io = {
    status: Qa,
    source: to,
  ...
  uo = {
    actions_array:
      "ADVARSEL: 'actions' bruges til at overskrive handlinger for eksisterende knapper. Hvis du vil tilføje yderligere handlinger skal du i stedet bruge 'shortcuts'.",
  },
  _o = {
    ...
    code_only_note:
      'Bemærk: Indstilling af actions og statistik er udelukkende muligt via Code Editor.',
  },
  mo = {
    status: ro,
    source: so,
  ...
  po = {
    ...
    description:
      'Vacuum card ermöglicht es Ihnen, Ihr Staubsaugerroboter zu steuern.',
    start: 'Reinigen',
    continue: 'Weiter',
    pause: 'Pausieren',
    stop: 'Stopp',
  ...
  vo = {
    actions_array:
      "WARNUNG: 'actions' ist dafür vorgesehen, die Standardaktionen für vorhandene Schaltflächen zu überschreiben. Wenn Sie zusätzliche Aktionen hinzufügen möchten, verwenden Sie stattdessen die Option 'shortcuts'.",
  },
  bo = {
    entity: 'Entität (Erforderlich)',
    map: 'Kartenkamera (Optional)',
    image: 'Bild (Optional)',
    ...
    code_only_note:
      'Hinweis: Das Festlegen von Aktionen und Statistikoptionen ist ausschließlich mit dem Code-Editor möglich.',
  },
  wo = {
    status: go,
    source: ho,
  ...
  Ao = {
    actions_array:
      "WARNING: 'actions' is reserved to override default actions for existing buttons. If your intention was to add additional actions, use the 'shortcuts' option instead.",
  },
  $o = {
    ...
    code_only_note:
      'Note: Setting actions and stats options are available exclusively using Code Editor.',
  },
  xo = {
    status: yo,
    source: ko,
  ...
  jo = {
    ...
    spot: 'Limpieza puntual',
    edge: 'Limpieza de bordes',
    single_room: 'Limpieza de una habitación',
    paused: 'En pausa',
    idle: 'Inactivo',
    stop: 'Detenido',
    charging: 'Cargando',
    ...
    going_to_target: 'Dirigiéndose al objetivo',
    zoned_cleaning: 'Limpieza por zonas',
    segment_cleaning: 'Limpieza por segmentos',
  },
  Eo = {
    gentle: 'Delicado',
    silent: 'Silencioso',
  ...
  Co = {
    name: 'Tarjeta del aspirador',
    description:
      'La tarjeta del aspirador le permite controlar su robot aspirador.',
    start: 'Comenzar',
    continue: 'Continuar',
    pause: 'Pausar',
    stop: 'Detener',
    ...
    not_available: 'El aspirador no está disponible',
  },
  Mo = {
  ...
  Oo = {
    actions_array:
      "ATENCIÓN: La opcion 'actions' está reservada para sobreescribir el comportamiento por defecto de los botones existentes. Si su intención es añadir acciones adicionales, debe utilizar la opcion 'shortcuts' en su lugar.",
  },
  Po = {
  ...
  Lo = {
    actions_array:
      "VAROITUS: 'actions' on varattu oletustoimintojen ylikirjoittamiseen olemassaolevissa painikkeissa. Jos tarkoituksesi on lisätä toimintoja, käytä 'shortcuts' -toimintoa.",
  },
  Uo = {
    ...
    code_only_note:
      'Huomaa: toimintojen ja tilastojen asetukset saatavilla ainoastaan koodieditorissa.',
  },
  Do = {
    status: To,
    source: Vo,
  ...
  Ho = {
    ...
    single_room: "Nettoyage d'une seule pièce",
    paused: 'En pause',
    idle: 'Inactif',
    stop: 'Arrêté',
    charging: 'En charge',
    ...
    remote_control_active: 'Télécommande active',
    manual_mode: 'Mode Manuel',
    shutting_down: 'Arrêt',
    updating: 'Mise à jour',
    going_to_target: 'Déplacement vers la cible',
    zoned_cleaning: 'Nettoyage des zones',
    segment_cleaning: 'Nettoyage des segments',
  },
  qo = {
    gentle: 'Doux',
    silent: 'Silencieux',
  ...
  Zo = {
    ...
    description:
      'La carte aspirateur vous permet de contrôler votre robot aspirateur.',
    start: 'Nettoyer',
    continue: 'Continuer',
  ...
  Ko = {
    actions_array:
      "AVERTISSEMENT : « Actions » est réservé à la substitution des actions par défaut des boutons existants. Si vous souhaitez ajouter des actions supplémentaires, utilisez plutôt l'option « Raccourcis ».",
  },
  Fo = {
    ...
    code_only_note:
      "Remarque: Les options de réglage des actions et statistiques sont disponibles exclusivement en utilisant l'éditeur de code.",
  },
  Wo = {
    status: Ho,
    source: qo,
  ...
  Go = {
    ...
    charging: 'בטעינה',
    returning: 'חוזר',
    returning_home: 'חוזר לעמדה',
    docked: 'בתחנה',
    unknown: 'לא ידוע',
    offline: 'מנותק',
    error: 'שגיאה',
    charger_disconnected: 'המטען מנותק',
    remote_control_active: 'שליטה מרחוק פעילה',
    manual_mode: 'מצב ידני',
    shutting_down: 'כיבוי',
    updating: 'עדכון',
    going_to_target: 'נוסע ליעד',
    zoned_cleaning: 'ניקוי אזורי',
    segment_cleaning: 'ניקוי מקטע',
  },
  Jo = {
    gentle: 'עדין',
    silent: 'שקט',
  ...
  Xo = {
    invalid_config: 'תצורה לא תקינה',
    missing_entity: 'יש צורך לציין ישות!',
  },
  Qo = {
    actions_array:
      "אזהרה: 'actions' שמור להחלפת פעולות ברירת המחדל של הכפתורים הקיימים. אם כוונתכם הייתה להוסיף פעולות נוספות, השתמשו באפשרות 'shortcuts' במקום זאת.",
  },
  tn = {
    entity: 'ישות (נדרש)',
    map: 'מצלמת מפה (אפשרי)',
    ...
    code_only_note:
      'הערה: הגדרת פעולות ואפשרויות סטטיסטיקה זמינות אך ורק באמצעות עורך הקוד.',
  },
  en = {
    status: Go,
    source: Jo,
  ...
  sn = {
    actions_array:
      "FIGYELEM: A 'actions' a meglévő gombok alapértelmezett műveleteinek felülbírálására szolgál. Ha további műveleteket szeretne hozzáadni, használja inkább a 'shortcuts' lehetőséget.",
  },
  ln = {
    ...
    code_only_note:
      'Megjegyzés: A műveletek és statisztika beállítások kizárólag a kód szerkesztő használatával érhetők el.',
  },
  cn = {
    status: an,
    source: on,
  ...
  un = {
    ...
    spot: 'Pulizia mirata',
    edge: 'Pulizia dei bordi',
    single_room: 'Pulizia di una stanza',
    paused: 'In pausa',
    idle: 'Inattivo',
    stop: 'Fermato',
    charging: 'In carica',
    returning: 'Rientro alla base',
    returning_home: 'Rientro alla base',
    docked: 'Alla base',
    unknown: 'Sconosciuto',
    ...
    going_to_target: 'In movimento verso la destinazione',
  ...
  dn = {
    name: 'Scheda aspirapolvere',
    description:
      'La scheda aspirapolvere consente di controllare il robot aspirapolvere.',
    start: 'Pulisci',
    continue: 'Continua',
    pause: 'Pausa',
    stop: 'Arresta',
  ...
  gn = {
    actions_array:
      "AVVISO: 'actions' è riservato per sovrascrivere le azioni predefinite dei pulsanti esistenti. Se la vostra intenzione era aggiungere azioni aggiuntive, usate invece l'opzione 'shortcuts'.",
  },
  hn = {
    ...
    code_only_note:
      "NB: La configurazione di azioni e statistiche sono disponibili soltanto nell'editor di codice.",
  },
  pn = {
    status: un,
    source: _n,
  ...
  yn = {
    actions_array:
      "警告：'actions'は既存のボタンのデフォルトアクションを上書きするために使用されています。アクションを追加したい場合は、'shortcuts' オプションを使用してください。",
  },
  kn = {
    entity: 'エンティティ（必須）',
    map: 'マップカメラ（オプション）',
    ...
    code_only_note:
      '注：actionとstatsのオプション設定は、コードエディターで行ってください。',
  },
  zn = {
    status: fn,
    source: vn,
  ...
  Sn = {
    ...
    charging: '충전 중',
    returning: '충전대로 복귀 중',
    returning_home: '기지로 복귀 중',
    docked: '도킹됨',
    unknown: '알수 없음',
    offline: '오프라인',
    error: '오류',
    charger_disconnected: '충전기가 분리됨',
    remote_control_active: '원격 제어 활성화',
    manual_mode: '수동 모드',
    shutting_down: '전원 종료 중',
    updating: '업데이트 중',
    going_to_target: '목표로 이동 중',
    zoned_cleaning: '구역 청소',
    segment_cleaning: '구간 청소',
  },
  An = {
    gentle: '저속',
    silent: '저소음',
  ...
  xn = {
    invalid_config: '잘못된 구성',
    missing_entity: '구성요소 지정이 필요합니다!',
  },
  jn = {
    actions_array:
      "경고: '동작'은 기존 버튼에 대한 기본 동작을 재정의하도록 예약되어 있습니다. 다른 동작을 추가하려는 경우 '바로가기' 옵션을 대신 사용하십시오.",
  },
  En = {
    entity: '구성요소 (필수)',
    map: '도면 (선택)',
    ...
    code_only_note:
      '참고: 동작 및 상태 옵션 설정은 코드 편집기에서만 사용할 수 있습니다.',
  },
  Cn = {
    status: Sn,
    source: An,
  ...
  Mn = {
    cleaning: 'Valo',
    auto: 'Automatinis valymas',
    spot: 'Vietinis valymas',
    edge: 'Kraštų valymas',
    single_room: 'Vieno kambario valymas',
    paused: 'Pristabdytas',
    idle: 'Neturi darbo',
    stop: 'Sustabdytas',
    charging: 'Kraunasi',
    returning: 'Grįžta į bazę',
    returning_home: 'Grįžta į bazę',
    docked: 'Doke',
    unknown: 'Nežinoma',
    offline: 'Neprisijungęs',
    error: 'Klaida',
    charger_disconnected: 'Įkroviklis atjungtas',
    remote_control_active: 'Nuotolinis valdymas aktyvus',
    manual_mode: 'Rankinis režimas',
    shutting_down: 'Išjungimas',
    updating: 'Atnaujinama',
    going_to_target: 'Vyksta į tikslą',
    zoned_cleaning: 'Zoninis valymas',
    segment_cleaning: 'Segmentų valymas',
  },
  On = {
    gentle: 'Švelnus',
    silent: 'Tylus',
  ...
  Nn = {
    invalid_config: 'Neteisinga konfigūracija',
    missing_entity: 'Būtina nurodyti entity!',
  },
  Tn = {
    actions_array:
      "ĮSPĖJIMAS: 'actions' skirtas esamų mygtukų numatytiesiems veiksmams perrašyti. Jei norėjote pridėti papildomų veiksmų, vietoje to naudokite parinktį 'shortcuts'.",
  },
  Vn = {
    ...
    code_only_note:
      'Pastaba: Veiksmų ir statistikos nustatymai gali būti redaguojami tik naudojantis kodo redaguotoju.',
  },
  Rn = {
    status: Mn,
    source: On,
  ...
  In = {
    cleaning: 'Rengjøring',
    auto: 'Automatisk rengjøring',
    spot: 'Punkt-rengjøring',
    edge: 'Kant-rengjøring',
    single_room: 'Rengjøring av ett rom',
    paused: 'Pauset',
    idle: 'Tomgang',
    stop: 'Stoppet',
    charging: 'Lader',
    returning: 'Returnerer til basen',
    returning_home: 'Returnerer til basen',
    docked: 'Dokket',
    unknown: 'Ukjent',
    offline: 'Frakoblet',
    error: 'Feil',
    charger_disconnected: 'Laderen er frakoblet',
    remote_control_active: 'Fjernkontroll aktiv',
    manual_mode: 'Manuell modus',
    shutting_down: 'Slår seg av',
    updating: 'Oppdaterer',
    going_to_target: 'Går til mål',
    zoned_cleaning: 'Sone-rengjøring',
    segment_cleaning: 'Segment-rengjøring',
  },
  Ln = {
    gentle: 'Skånsom',
    silent: 'Stille',
  ...
  Un = {
    ...
    pause: 'Paus',
    stop: 'Stopp',
    return_to_base: 'Til basen',
    locate: 'Lokaliser støvsuger',
    not_available: 'Støvsugeren er ikke tilgjengelig',
  },
  Dn = {
    invalid_config: 'Ugyldig konfigurasjon',
    missing_entity: 'Spesifiserende enhet kreves!',
  },
  Hn = {
    actions_array:
      "ADVARSEL: 'actions' er reservert for å overstyre standardhandlinger for eksisterende knapper. Hvis hensikten var å legge til flere handlinger, bruk heller alternativet 'shortcuts'.",
  },
  qn = {
    ...
    code_only_note:
      'Merk: Innstillingshandlinger og statistikkalternativer er eksklusivt tilgjengelige ved hjelp av Code Editor.',
  },
  Zn = {
    status: In,
    source: Ln,
  ...
  Bn = {
    ...
    auto: 'Automatische reiniging',
    spot: 'Plaatselijke reiniging',
    edge: 'Randreiniging',
    single_room: 'Reiniging van één kamer',
    paused: 'Gepauzeerd',
    idle: 'Inactief',
    stop: 'Gestopt',
    charging: 'Aan het opladen',
    returning: 'Keert terug naar het basisstation',
    returning_home: 'Keert terug naar het basisstation',
    docked: 'Gedockt',
    unknown: 'Onbekend',
    offline: 'Niet verbonden',
    error: 'Fout',
    charger_disconnected: 'Lader losgekoppeld',
    remote_control_active: 'Afstandsbediening actief',
    manual_mode: 'Handmatige modus',
    shutting_down: 'Uitschakelen',
    updating: 'Bijwerken',
    going_to_target: 'Onderweg naar doel',
    zoned_cleaning: 'Zonereiniging',
    segment_cleaning: 'Segmentreiniging',
  },
  Kn = {
    gentle: 'Zacht',
    silent: 'Stil',
  ...
  Fn = {
    ...
    description:
      'Stofzuiger kaart maakt het makkelijk om je robotstofzuiger te bedienen.',
    start: 'Start',
    continue: 'Doorgaan',
    pause: 'Pauze',
    stop: 'Stoppen',
    ...
    not_available: 'Stofzuiger is niet beschikbaar',
  },
  Wn = {
  ...
  Gn = {
    actions_array:
      "WAARSCHUWING: 'actions' is gereserveerd om standaardacties voor bestaande knoppen te overschrijven. Als uw bedoeling was om extra acties toe te voegen, gebruik dan de optie 'shortcuts' in plaats daarvan.",
  },
  Jn = {
    ...
    show_status: 'Status tonen',
    show_status_aria_label_on: 'Statusweergave inschakelen',
    show_status_aria_label_off: 'Statusweergave uitschakelen',
    show_toolbar: 'Werkbalk laten zien?',
    show_toolbar_aria_label_on: 'Zet werkbalk aan',
    show_toolbar_aria_label_off: 'Zet werkbalk uit',
    code_only_note:
      'Notitie: Instel acties en status opties zijn alleen beschikbaar in de Code Editor',
  },
  Yn = {
    status: Bn,
    source: Kn,
  ...
  Xn = {
    cleaning: 'Rengjer',
    auto: 'Automatisk reinhald',
    spot: 'Punktreinhald',
    edge: 'Kantreinhald',
    single_room: 'Reinhald av eitt rom',
    paused: 'Pausa',
    idle: 'Tomgang',
    stop: 'Stoppa',
    charging: 'Ladar',
    ...
    offline: 'Fråkopla',
    error: 'Feil',
    charger_disconnected: 'Ladaren er fråkopla',
    remote_control_active: 'Fjernkontroll aktiv',
    manual_mode: 'Manuell modus',
    shutting_down: 'Slår seg av',
    updating: 'Oppdaterer',
    going_to_target: 'Går til mål',
    zoned_cleaning: 'Sone-reinhald',
    segment_cleaning: 'Segment-reinhald',
  },
  Qn = {
    gentle: 'Skånsam',
    silent: 'Stille',
  ...
  ai = {
    actions_array:
      "ÅTVARING: 'actions' er reservert for å overstyre standardhandlingar for eksisterande knappar. Dersom føremålet var å leggje til fleire handlingar, bruk i staden alternativet 'shortcuts'.",
  },
  oi = {
    ...
    code_only_note:
      'Merk: Innstillingshandlingar og statistikkalternativ er berre tilgjengeleg ved hjelp av Code Editor.',
  },
  ni = {
    status: Xn,
    source: Qn,
  ...
  ci = {
    actions_array:
      "OSTRZEŻENIE: 'actions' jest zarezerwowane dla zmiany zachowania domyślnych akcji przycisków. Jeśli chcesz dodać dodatkowe akcje, użyj w zamian opcji 'shortcuts'.",
  },
  ui = {
    ...
    code_only_note:
      'Uwaga: Ustawianie opcji i informacji statystyk jest dostępne tylko poprzez edytor kodu YAML.',
  },
  _i = {
    status: ii,
    source: ri,
  ...
  gi = {
    name: 'Cartão do aspirador',
    description: 'O cartão do aspirador permite controlar o robô aspirador.',
    start: 'Limpar',
    continue: 'Continuar',
    pause: 'Pausar',
    stop: 'Parar',
    return_to_base: 'Base',
    locate: 'Localizar aspirador',
    not_available: 'O aspirador não está disponível',
  },
  hi = {
  ...
  pi = {
    actions_array:
      "AVISO: 'actions' está reservado para substituir ações padrão de botões existentes. Se a sua intenção era adicionar ações adicionais, utilize a opção 'shortcuts'.",
  },
  fi = {
    ...
    code_only_note:
      'Nota: Ações e estatísticas estão disponiveis exclusivamente usando o Editor de Código.',
  },
  vi = {
    status: di,
    source: mi,
  ...
  bi = {
    ...
    spot: 'Limpeza localizada',
    edge: 'Limpeza de bordas',
    single_room: 'Limpeza de um único cômodo',
    paused: 'Em pausa',
    idle: 'Ocioso',
    stop: 'Parado',
    charging: 'Carregando',
    returning: 'Retornando à base',
    returning_home: 'Retornando à base',
    docked: 'Na base',
    unknown: 'Desconhecido',
    ...
    going_to_target: 'Indo ao destino',
    zoned_cleaning: 'Limpeza por zonas',
    segment_cleaning: 'Limpeza por segmentos',
  },
  wi = {
  ...
  zi = {
    actions_array:
      "AVISO: 'actions' são reservadas para substituir as ações padrões para botões existentes. Se sua intenção era adicionar ações adicionais, use a opção 'shortcuts'.",
  },
  Si = {
  ...
  $i = {
    ...
    returning_home: 'Se întoarce la bază',
    docked: 'Parcat',
    unknown: 'Necunoscut',
    offline: 'Deconectat',
    error: 'Eroare',
    charger_disconnected: 'Încărcător deconectat',
    remote_control_active: 'Control la distanță activ',
    manual_mode: 'Mod manual',
    shutting_down: 'Se oprește',
    updating: 'Se actualizează',
    going_to_target: 'Se îndreaptă către țintă',
    zoned_cleaning: 'Curățare pe zone',
    segment_cleaning: 'Curățare pe segmente',
  },
  xi = {
    gentle: 'Blând',
    silent: 'Silențios',
  ...
  Ci = {
    actions_array:
      "AVERTISMENT: 'actions' este rezervat pentru suprascrierea acțiunilor implicite ale butoanelor existente. Dacă intenția dvs. a fost să adăugați acțiuni suplimentare, folosiți în schimb opțiunea 'shortcuts'.",
  },
  Mi = {
    ...
    compact_view_aria_label_off:
      'Oprește vizualizare compactă compact view off',
    ...
    code_only_note:
      'Notă: Acțiunile de setare și opțiunile de statistici sunt disponibile exclusiv folosind Editorul de cod.',
  },
  Oi = {
    status: $i,
    source: xi,
  ...
  Pi = {
    ...
    single_room: 'Уборка одной комнаты',
    paused: 'Пауза',
    idle: 'Ожидает',
    stop: 'Остановлен',
    charging: 'Заряжается',
    returning: 'Возвращается',
    returning_home: 'Возвращается на базу',
    docked: 'На базе',
    unknown: 'Неизвестен',
    offline: 'Не в сети',
    error: 'Ошибка',
    ...
    segment_cleaning: 'Сегментная уборка',
  },
  Ni = {
    gentle: 'Деликатный',
    silent: 'Тихий',
  ...
  Ti = {
    name: 'Карта пылесоса',
    description: 'Карта пылесоса позволяет управлять роботом‑пылесосом.',
    start: 'Запуск',
    continue: 'Продолжить',
    pause: 'Пауза',
    stop: 'Остановить',
    return_to_base: 'На базу',
    locate: 'Найти пылесос',
  ...
  Ri = {
    actions_array:
      "WARNING: 'actions' зарезервированы для переопределения действий встроенных кнопок. Если вы хотите добавить дополнительные действия, используйте опцию 'shortcuts'.",
  },
  Ii = {
    ...
    code_only_note:
      'Внимание: Опции actions и stats доступны исключительно через редактор кода.',
  },
  Li = {
    status: Pi,
    source: Ni,
  ...
  Ui = {
    cleaning: 'Städar',
    auto: 'Automatisk rengöring',
    spot: 'Punktstädning',
    edge: 'Kantstädning',
    single_room: 'Rengöring av ett rum',
    paused: 'Pausad',
    idle: 'Inaktiv',
    stop: 'Stoppad',
    charging: 'Laddar',
    returning: 'Återvänder till basen',
    returning_home: 'Återvänder till basen',
    docked: 'Dockad',
    unknown: 'Okänd',
    offline: 'Frånkopplad',
    error: 'Fel',
    charger_disconnected: 'Laddaren är frånkopplad',
    remote_control_active: 'Fjärrkontroll aktiv',
    manual_mode: 'Manuellt läge',
    shutting_down: 'Stänger av',
    updating: 'Uppdaterar',
    going_to_target: 'Går till mål',
    zoned_cleaning: 'Zonstädning',
    segment_cleaning: 'Segmentstädning',
  },
  Di = {
  ...
  Zi = {
    actions_array:
      "VARNING: 'actions' är reserverat för att skriva över standardåtgärder för befintliga knappar. Om avsikten var att lägga till ytterligare åtgärder, använd i stället alternativet 'shortcuts'.",
  },
  Bi = {
    ...
    code_only_note:
      'Obs! Inställningar för händelser och statistikalternativ är enbart tillgängliga med kodredigeraren.',
  },
  Ki = {
    status: Ui,
    source: Di,
  ...
  Fi = {
    ...
    offline: '離線',
    error: '錯誤',
    charger_disconnected: '充電器已斷開',
    remote_control_active: '遠端控制已啟用',
    manual_mode: '手動模式',
    shutting_down: '關機中',
    updating: '更新中',
    going_to_target: '前往目標',
    zoned_cleaning: '分區清掃',
    segment_cleaning: '分段清掃',
  },
  Wi = {
    gentle: '柔和',
    silent: '靜音',
  ...
  Ji = { invalid_config: '設定無效', missing_entity: '必須指定一個實體!' },
  Yi = {
    actions_array:
      "警告：'actions' 保留用於覆寫現有按鈕的預設動作。若您的意圖是新增額外動作，請改用 'shortcuts' 選項。",
  },
  Xi = {
    entity: '實體 (必填)',
    map: '地圖 (選填)',
    ...
    code_only_note:
      '提醒: 如果要使用 actions 和 stats 選項，請使用編碼編輯器編輯',
  },
  Qi = {
    status: Fi,
    source: Wi,
  ...
  tr = {
    ...
    returning_home: 'Повертається на базу',
  ...
  ar = {
    name: 'Картка пилососа',
    description: 'Картка пилососа дає змогу керувати роботом‑пилососом.',
    start: 'Старт',
    continue: 'Продовжити',
    pause: 'Пауза',
    stop: 'Стоп',
    return_to_base: 'На базу',
    locate: 'Знайти пилосос',
    not_available: 'Пилосос недоступний',
  },
  or = {
    invalid_config: 'Неправильна конфігурація',
    missing_entity: 'Необхідно вказати сутність!',
  },
  nr = {
    actions_array:
      "УВАГА: 'actions' зарезервовані для зміни поведінки вбудованих кнопок. Якщо ви хотіли додати додаткові кнопки, скористайтесь об’єктом 'shortcuts'.",
  },
  ir = {
    ...
    code_only_note:
      'Увага: Опції actions та stats доступні виключно через редактор коду.',
  },
  rr = {
    status: tr,
    source: er,
  ...
  sr = {
    ...
    auto: 'Làm sạch tự động',
    spot: 'Làm sạch điểm',
    edge: 'Làm sạch viền',
    single_room: 'Làm sạch một phòng',
    paused: 'Dừng',
    idle: 'Nghỉ',
    stop: 'Đã dừng',
    charging: 'Đang sạc',
    returning: 'Đang về đế',
    returning_home: 'Đang về đế',
    docked: 'Đang ở Dock',
    unknown: 'Không rõ',
    offline: 'Ngoại tuyến',
    error: 'Lỗi',
    charger_disconnected: 'Bộ sạc đã ngắt kết nối',
    remote_control_active: 'Điều khiển từ xa đang hoạt động',
    manual_mode: 'Chế độ thủ công',
    shutting_down: 'Đang tắt',
    updating: 'Đang cập nhật',
    going_to_target: 'Đang đi đến mục tiêu',
    zoned_cleaning: 'Làm sạch theo vùng',
    segment_cleaning: 'Làm sạch theo phân đoạn',
  },
  lr = {
    gentle: 'Nhẹ',
    silent: 'Yên tĩnh',
  ...
  cr = {
    ...
    description:
      'Robot hút bụi Card cho phép bạn điều khiển robot hút bụi một cách dễ dàng',
    start: 'Dọn dẹp',
    continue: 'Tiếp tục',
    pause: 'Tạm dừng',
    stop: 'Dừng',
  ...
  _r = {
    actions_array:
      "CẢNH BÁO: 'actions' được dành riêng để ghi đè các hành động mặc định của các nút hiện có. Nếu quý vị muốn thêm các hành động bổ sung, vui lòng dùng tùy chọn 'shortcuts' thay thế.",
  },
  dr = {
    ...
    code_only_note:
      'Lưu ý: Cài đặt thao tác và tùy chọn thống kê chỉ có sẵn bằng trình chỉnh sửa mã',
  },
  mr = {
    status: sr,
    source: lr,
...
function pr(t, e, a) {
  var o;
  const [n, i] = t.toLowerCase().split('.');
  let r = null;
  try {
    r = JSON.parse(
      null !== (o = localStorage.getItem('selectedLanguage')) && void 0 !== o
        ? o
        : '',
    );
  } catch (t) {
    r = localStorage.getItem('selectedLanguage');
  }
  const s = (r || navigator.language.split('-')[0] || hr)
    .replace(/['"]+/g, '')
    .replace('-', '_')
    .toLowerCase();
  let l;
  ...
  if ((void 0 === l && (l = gr[hr][n][i]), void 0 !== l)) return l;
}
function fr(t, e) {
  void 0 === e && (e = {});
  var a = e.insertAt;
...
var vr = r`:host{--vc-background:transparent;--vc-primary-text-color:var(--primary-text-color);--vc-secondary-text-color:var(--secondary-text-color);--vc-icon-color:var(--secondary-text-color);--vc-toolbar-background:var(--vc-background);--vc-toolbar-text-color:var(--secondary-text-color);--vc-toolbar-icon-color:var(--secondary-text-color);--vc-divider-color:var(--entities-divider-color, var(--divider-color));--vc-spacing:10px;display:flex;flex:1;flex-direction:column}ha-card{flex-direction:column;flex:1;position:relative;overflow:hidden}.preview{background:var(--vc-background);position:relative;text-align:center}.preview.not-available{filter:grayscale(1)}.header{display:flex;justify-content:space-between}.tips{display:flex;gap:var(--vc-spacing);flex-grow:1;flex-wrap:wrap;padding:var(--vc-spacing)}.tips .tip{cursor:pointer}.map{max-width:95%;image-rendering:crisp-edges;cursor:pointer}@keyframes cleaning{0%{transform:rotate(0) translate(0)}5%{transform:rotate(0) translate(0,-10px)}10%{transform:rotate(0) translate(0,5px)}15%{transform:rotate(0) translate(0)}20%{transform:rotate(30deg) translate(0)}25%{transform:rotate(30deg) translate(0,-10px)}30%{transform:rotate(30deg) translate(0,5px)}35%{transform:rotate(30deg) translate(0)}40%{transform:rotate(0) translate(0)}45%{transform:rotate(-30deg) translate(0)}50%{transform:rotate(-30deg) translate(0,-10px)}55%{transform:rotate(-30deg) translate(0,5px)}60%{transform:rotate(-30deg) translate(0)}70%{transform:rotate(0) translate(0)}100%{transform:rotate(0)}}@keyframes returning{0%{transform:rotate(0)}25%{transform:rotate(10deg)}50%{transform:rotate(0)}75%{transform:rotate(-10deg)}100%{transform:rotate(0)}}.vacuum{display:block;max-width:90%;max-height:200px;image-rendering:crisp-edges;margin:var(--vc-spacing) auto;cursor:pointer;filter:brightness(.9)}.vacuum.auto,.vacuum.cleaning,.vacuum.edge,.vacuum.on,.vacuum.single_room,.vacuum.spot{animation:cleaning 5s linear infinite}.vacuum.returning{animation:returning 2s linear infinite}.vacuum.paused{opacity:1}.vacuum.docked{opacity:.5}.status{display:flex;align-items:center;justify-content:center;direction:ltr}.status-text{color:var(--vc-secondary-text-color);white-space:nowrap;text-overflow:ellipsis;overflow:hidden;margin-left:0}.status mwc-circular-progress{--mdc-theme-primary:var(--vc-secondary-text-color)!important;margin-left:var(--vc-spacing)}.vacuum-name{text-align:center;font-weight:700;color:var(--vc-primary-text-color);font-size:16px}.not-available .offline{text-align:center;color:var(--vc-primary-text-color);font-size:16px}.metadata{margin:var(--vc-spacing) auto}.stats{border-top:1px solid var(--vc-divider-color);display:flex;flex-direction:row;justify-content:space-evenly;color:var(--vc-secondary-text-color)}.stats-block{cursor:pointer;padding:var(--vc-spacing) 0;text-align:center;border-right:1px solid var(--vc-divider-color);flex-grow:1}.stats-block:last-of-type{border-right:0}.stats-value{font-size:20px;color:var(--vc-primary-text-color)}ha-icon{color:var(--vc-icon-color)}.toolbar{background:var(--vc-toolbar-background);min-height:30px;display:flex;flex-direction:row;flex-flow:row wrap;flex-wrap:wrap;justify-content:space-evenly;padding:5px;border-top:1px solid var(--vc-divider-color)}.toolbar-button{display:flex;flex-direction:column;align-items:center;cursor:pointer;padding:8px;-moz-user-select:none;user-select:none;-webkit-user-select:none}.toolbar-button-text{color:var(--vc-toolbar-text-color);font-size:12px;margin-top:-4px}.toolbar-button ha-icon-button{color:var(--vc-toolbar-text-color);width:44px;height:44px;--mdc-icon-button-size:44px}.toolbar ha-icon{color:var(--vc-toolbar-icon-color);display:flex}.battery-label{font-size:14px;color:var(--vc-secondary-text-color)}`;
fr(vr);
var br;
(console.info(
  '%c VACUUM-CARD %c 2.11.7',
  ...
  customElements.get('ha-icon-button') ||
    customElements.define(
      'ha-icon-button',
      class extends (null !== (br = customElements.get('paper-icon-button')) &&
      void 0 !== br
        ? br
        : HTMLElement) {},
    ));
let wr = class extends st {
  ...
  static async getConfigElement() {
    return (
      ...
      document.createElement('vacuum-card-editor')
    );
  }
  static getStubConfig(t, e) {
    const [a] = e.filter((t) => t.startsWith('vacuum'));
    return { entity: null != a ? a : '' };
  }
  get entity() {
    return this.hass.states[this.config.entity];
  }
  get map() {
    return this.hass && this.config.map
      ? this.hass.states[this.config.map]
      : null;
  }
  setConfig(t) {
    this.config = (function (t) {
      var e, a, o, n, i, r, s, l, c, u;
      if (!t) throw new Error(pr('error.invalid_config'));
      if (!t.entity) throw new Error(pr('error.missing_entity'));
      const _ = t.actions;
      return (
        _ && Array.isArray(_) && console.warn(pr('warning.actions_array')),
        {
          entity: t.entity,
          battery_entity: t.battery_entity,
          map: null !== (e = t.map) && void 0 !== e ? e : '',
          map_refresh: null !== (a = t.map_refresh) && void 0 !== a ? a : 5,
          image: null !== (o = t.image) && void 0 !== o ? o : 'default',
          show_name: null === (n = t.show_name) || void 0 === n || n,
          show_status: null === (i = t.show_status) || void 0 === i || i,
          show_toolbar: null === (r = t.show_toolbar) || void 0 === r || r,
          compact_view: null !== (s = t.compact_view) && void 0 !== s && s,
          stats: null !== (l = t.stats) && void 0 !== l ? l : {},
          actions: null !== (c = t.actions) && void 0 !== c ? c : {},
          shortcuts: null !== (u = t.shortcuts) && void 0 !== u ? u : [],
        }
      );
    })(t);
  }
  ...
  getWatchedEntities() {
    const t = this.getEntityPrefix(),
      e = [
        this.config.entity,
        `sensor.${t}_status`,
        `sensor.${t}_vacuum_error`,
        `sensor.${t}_dock_dock_error`,
        `binary_sensor.${t}_dock_mop_drying`,
        `binary_sensor.${t}_cleaning`,
        `sensor.${t}_current_room`,
        `sensor.${t}_dock_mop_drying_remaining_time`,
      ];
    return (
      this.config.battery_entity && e.push(this.config.battery_entity),
      e
    );
  }
  shouldUpdate(t) {
    ...
    if (
      (function (t, e, a) {
        if (e.has('config') || a) return !0;
        if (t.config.entity) {
          var o = e.get('hass');
          return (
            !o || o.states[t.config.entity] !== t.hass.states[t.config.entity]
          );
        }
        return !1;
      })(this, t, !1)
    ...
    if (t.has('hass')) {
      const o = t.get('hass');
      if (o)
        for (const t of this.getWatchedEntities()) {
          if (
            (null === (e = o.states[t]) || void 0 === e ? void 0 : e.state) !==
            (null === (a = this.hass.states[t]) || void 0 === a
              ? void 0
              : a.state)
          )
            return !0;
  ...
  updated(t) {
    t.get('hass') &&
      t.get('hass').states[this.config.entity].state !==
  ...
  processValueTemplate(t, e) {
    ...
    for (const t of o) {
      ...
      switch (o) {
        ...
        case 'int':
          ...
          break;
        case 'round': {
          const t = n ? parseInt(n, 10) : 0;
          a = Number(a.toFixed(t));
          break;
        }
        case 'abs':
          a = Math.abs(a);
    ...
    if (!Number.isInteger(a)) {
      const t = e.match(/round\((\d+)\)/),
        o = t ? parseInt(t[1], 10) : 0;
      a = Number(a.toFixed(o));
    }
    return a;
  }
  renderStats(t) {
    const e = (this.config.stats[t] || this.config.stats.default || []).map(
      ({
        ...
        if (!t && !e) return B;
        let i = '';
        if (t && e) i = Va(this.hass.states[t].attributes, e);
        else if (e) i = Va(this.entity.attributes, e);
        else {
          if (!t) return B;
          i = this.hass.states[t].state;
        }
        const r = this.processValueTemplate(i, a);
        return q`<div class="stats-block" @click="${() => this.handleMore(t)}"><span class="stats-value">${r}</span> ${o}<div class="stats-subtitle">${n}</div></div>`;
      },
    );
    return e.length ? q`<div class="stats">${e}</div>` : B;
  }
  renderName() {
    const { friendly_name: t } = this.getAttributes(this.entity);
    return this.config.show_name ? q`<div class="vacuum-name">${t}</div>` : B;
  }
  getEntityPrefix() {
  ...
  getState(t) {
    ...
    return null !== (e = null == a ? void 0 : a.state) && void 0 !== e ? e : '';
  }
  isState(t, e) {
    return this.getState(t) === e;
  }
  formatStatus(t) {
    if (!t || ['unknown', 'unavailable', 'none', ''].includes(t)) return 'Idle';
    const e = t.replace(/_/g, ' ').toLowerCase();
    return e.charAt(0).toUpperCase() + e.slice(1);
  }
  buildStatusText() {
    const t = this.getEntityPrefix(),
      e = this.getState(`sensor.${t}_status`),
      a = this.getState(`sensor.${t}_vacuum_error`),
      o = this.getState(`sensor.${t}_dock_dock_error`),
      n = this.isState(`binary_sensor.${t}_dock_mop_drying`, 'on'),
      i = this.isState(`binary_sensor.${t}_cleaning`, 'on'),
      r = this.getState(`sensor.${t}_current_room`),
      s = this.getState(`sensor.${t}_dock_mop_drying_remaining_time`),
      l = parseInt(s, 10) || 0;
    if (a && !['none', 'unknown', 'unavailable', ''].includes(a))
      return `Error: ${this.formatStatus(a)}`;
    if (o && !['ok', 'none', 'unknown', 'unavailable', ''].includes(o))
      return `Dock: ${this.formatStatus(o)}`;
    if (n) {
      const t = Math.ceil(l / 60),
        e = Math.floor(t / 60),
        a = t % 60;
      let o = '—';
      return (
    ...
    return i && r && !['unknown', 'unavailable', 'none', ''].includes(r)
      ? `Cleaning ${r.toLowerCase()}`
      : this.formatStatus(e);
  }
  renderStatus() {
    if (!this.config.show_status) return B;
    const t = this.buildStatusText();
    return q`<div class="status"><span class="status-text" alt="${t}">${t}</span><ha-circular-progress .indeterminate="${this.requestInProgress}" size="small"></ha-circular-progress></div>`;
  }
  renderToolbar(t) {
    if (!this.config.show_toolbar) return B;
    switch (t) {
      case 'on':
      case 'auto':
      case 'spot':
      ...
      case 'single_room':
      case 'cleaning':
        return q`<div class="toolbar"><div class="toolbar-button" @click="${this.handleVacuumAction('pause')}"><ha-icon-button><ha-icon icon="hass:pause"></ha-icon></ha-icon-button><span class="toolbar-button-text">${pr('common.pause')}</span></div><div class="toolbar-button" @click="${this.handleVacuumAction('return_to_base')}"><ha-icon-button><ha-icon icon="hass:home-map-marker"></ha-icon></ha-icon-button><span class="toolbar-button-text">${pr('common.return_to_base')}</span></div></div>`;
      case 'paused':
        return q`<div class="toolbar"><div class="toolbar-button" @click="${this.handleVacuumAction('resume', { defaultService: 'start', request: !0 })}"><ha-icon-button><ha-icon icon="hass:play"></ha-icon></ha-icon-button><span class="toolbar-button-text">${pr('common.continue')}</span></div><div class="toolbar-button" @click="${this.handleVacuumAction('return_to_base')}"><ha-icon-button><ha-icon icon="hass:home-map-marker"></ha-icon></ha-icon-button><span class="toolbar-button-text">${pr('common.return_to_base')}</span></div></div>`;
      default: {
        const t = this.config.shortcuts.map(
          ({ name: t, service: e, icon: a, service_data: o, target: n }) =>
            q`<div class="toolbar-button" @click="${() => {
              if (e)
            ...
            }}"><ha-icon-button><ha-icon icon="${a}"></ha-icon></ha-icon-button><span class="toolbar-button-text">${t}</span></div>`,
        );
        return q`<div class="toolbar">${t}</div>`;
      }
    }
  }
  renderUnavailable() {
    return q`<ha-card><div class="preview not-available"><div class="metadata"><div class="not-available">${pr('common.not_available')}</div><div></div></div></div></ha-card>`;
  }
  render() {
    return this.entity
      ? q`<ha-card><ha-ripple></ha-ripple><div class="preview"><div class="header"><div class="tips">${this.renderBattery()}</div></div>${this.renderMapOrImage(this.entity.state)}<div class="metadata">${this.renderName()} ${this.renderStatus()}</div>${this.renderStats(this.entity.state)}</div>${this.renderToolbar(this.entity.state)}</ha-card>`
      : this.renderUnavailable();
  }
};
(t([dt({ attribute: !1 })], wr.prototype, 'hass', void 0),
  t([mt()], wr.prototype, 'config', void 0),
  t([mt()], wr.prototype, 'requestInProgress', void 0),
  t([mt()], wr.prototype, 'thumbUpdater', void 0),
  (wr = t([ct('vacuum-card')], wr)),
  (window.customCards = window.customCards || []),
  window.customCards.push({
    preview: !0,
    type: 'vacuum-card',
    name: pr('common.name'),
    description: pr('common.description'),
  }));
var yr = r`.card-config{flex-direction:column;display:flex;gap:10px}.option{display:flex;align-items:center}.option ha-switch{margin-right:10px}.option ha-select,.option paper-input{width:100%}`;
fr(yr);
let kr = class extends st {
  constructor() {
    (super(...arguments),
      (this.image = void 0),
      (this.compact_view = !1),
  ...
  setConfig(t) {
    ((this.config = t),
      this.config.entity ||
        ...
        pt(this, 'config-changed', { config: this.config })));
  }
  getEntitiesByType(t) {
    return this.hass
      ? Object.keys(this.hass.states).filter((e) => e.startsWith(t))
      : [];
  }
  render() {
    if (!this.hass) return B;
    const t = this.getEntitiesByType('vacuum'),
      e = [
        ...this.getEntitiesByType('camera'),
        ...this.getEntitiesByType('image'),
      ];
    return q`<div class="card-config"><div class="option"><ha-select .label="${pr('editor.entity')}" @selected="${this.valueChanged}" .configValue="${'entity'}" .value="${this.config.entity}" @closed="${(t) => t.stopPropagation()}" fixedMenuPosition naturalMenuWidth required validationMessage="${pr('error.missing_entity')}">${t.map((t) => q`<mwc-list-item .value="${t}">${t}</mwc-list-item>`)}</ha-select></div><div class="option"><ha-select .label="${pr('editor.map')}" @selected="${this.valueChanged}" .configValue="${'map'}" .value="${this.config.map}" @closed="${(t) => t.stopPropagation()}" fixedMenuPosition naturalMenuWidth>${e.map((t) => q`<mwc-list-item .value="${t}">${t}</mwc-list-item>`)}</ha-select></div><div class="option"><paper-input label="${pr('editor.image')}" .value="${this.image}" .configValue="${'image'}" @value-changed="${this.valueChanged}"></paper-input></div><div class="option"><ha-switch aria-label="${pr(this.compact_view ? 'editor.compact_view_aria_label_off' : 'editor.compact_view_aria_label_on')}" .checked="${Boolean(this.compact_view)}" .configValue="${'compact_view'}" @change="${this.valueChanged}"></ha-switch>${pr('editor.compact_view')}</div><div class="option"><ha-switch aria-label="${pr(this.show_name ? 'editor.show_name_aria_label_off' : 'editor.show_name_aria_label_on')}" .checked="${Boolean(this.show_name)}" .configValue="${'show_name'}" @change="${this.valueChanged}"></ha-switch>${pr('editor.show_name')}</div><div class="option"><ha-switch aria-label="${pr(this.show_status ? 'editor.show_status_aria_label_off' : 'editor.show_status_aria_label_on')}" .checked="${Boolean(this.show_status)}" .configValue="${'show_status'}" @change="${this.valueChanged}"></ha-switch>${pr('editor.show_status')}</div><div class="option"><ha-switch aria-label="${pr(this.show_toolbar ? 'editor.show_toolbar_aria_label_off' : 'editor.show_toolbar_aria_label_on')}" .checked="${Boolean(this.show_toolbar)}" .configValue="${'show_toolbar'}" @change="${this.valueChanged}"></ha-switch>${pr('editor.show_toolbar')}</div><strong>${pr('editor.code_only_note')}</strong></div>`;
  }
  valueChanged(t) {
    if (!this.config || !this.hass || !t.target) return;
    const e = t.target;
    e.configValue &&
      this.config[e.configValue] !== (null == e ? void 0 : e.value) &&
      (e.configValue &&
        ('' === e.value
          ? delete this.config[e.configValue]
          : (this.config = Object.assign(Object.assign({}, this.config), {
              [e.configValue]: void 0 !== e.checked ? e.checked : e.value,
            }))),
      pt(this, 'config-changed', { config: this.config }));
  }
  static get styles() {
...
(t([dt({ attribute: !1 })], kr.prototype, 'hass', void 0),
  t([mt()], kr.prototype, 'config', void 0),
  t([mt()], kr.prototype, 'image', void 0),
  t([mt()], kr.prototype, 'compact_view', void 0),
  t([mt()], kr.prototype, 'show_name', void 0),
  t([mt()], kr.prototype, 'show_status', void 0),
  t([mt()], kr.prototype, 'show_toolbar', void 0),
  (kr = t([ct('vacuum-card-editor')], kr)));
var zr = Object.freeze({
  __proto__: null,
  get VacuumCardEditor() {
    return kr;
  },
});
export { wr as VacuumCard };
